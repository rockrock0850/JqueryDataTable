$(document).ready(function() {
	document.title = '測試Jquery DataTale的效能';
	...
	$table.DataTable({
		...
		aoColumnDefs: [ // 欄位設定
			{bSortable: false, aTargets: []}, // 選擇關閉哪個欄位排序功能(  )
			{
				...
				defaultContent: "<button class='content_button'>測試</button>"
			},
			{sWidth: '5.5%', aTargets: [1], title: '', data: 'FLOW_ID', className: 'FLOW_ID'}, 
	...
	/* 隱藏欄位 */
	$table.find('.FLOW_ID').attr('style', 'display: none;');
});